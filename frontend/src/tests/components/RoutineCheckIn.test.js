...
describe('RoutineCheckIn UI', () => {
  ...
  test('renders correctly in light mode', async () => {
    ...
    const container = screen.getByText('Today\'s Skincare Routine').closest('.routine-checkin-container');
    expect(container).toBeInTheDocument();
    
    const morningCard = screen.getByText('Morning Routine').closest('.routine-card');
    const eveningCard = screen.getByText('Evening Routine').closest('.routine-card');
